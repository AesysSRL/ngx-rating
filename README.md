...
- rounded_squares:
    ...
    ![Rounded Squares](projects/ngx-rating/assets/rounded-squares.gif)

- single_icon:

    ![Single Icon](projects/ngx-rating/assets/simple-icon.gif)
...
- multiple_icons:
    ...
    ![Multiple Icons](projects/ngx-rating/assets/multiple-icons.gif)
